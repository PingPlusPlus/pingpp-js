!function (a, b, c) {
    ...
    function f(b, c, d, e, f) {
        if (b && c && d) {
            var g, h, i, j, k = b + "://" + c + "/" + d;
            if (e = e || [], !f || !N[f] && !window[f])for (f = null, h = 0, i = e.length; i > h; h++)if (g = e[h], a.isObject(g) && (g = g.callbackName || g.callback), g && (N[g] || window[g])) {
                f = g;
                break
            }
            f && (O[f] = {
                ...
                uri: k,
                startTime: Date.now()
            }, j = String(f).match(/__MQQ_CALLBACK_(\d+)/), j && (O[j[1]] = O[f])), C.send(k, S)
        }
    }
    ...
    function k(d, f, g, h) {
        var i, k, l, m = a.isFunction(d) ? d : N[d] || window[d], n = Date.now();
        f = f || [], i = f[0], a.isUndefined(h) && (h = !0), a.isObject(i) && ("data" in i || (i.data = c({}, i)), "code" in i || (i.code = j(i) || 0), i.msg = i.msg || ""), a.isFunction(m) ? h ? setTimeout(function () {
            m.apply(null, f)
        }, 0) : m.apply(null, f) : console.log("mqqapi: not found such callback: " + d + " or the callback: " + d + " had some errors! API: " + d.name), g && (delete N[d], delete window["__MQQ_CALLBACK_" + d]), O[d] && (l = O[d], delete O[d], e({
            from: "fireCallback",
            ns: l.ns,
            method: l.method,
            ret: JSON.stringify(f),
            url: l.uri
        }), Number(d) && delete O["__MQQ_CALLBACK_" + d], i && (i.code !== b ? k = i.code : /^-?\d+$/.test(String(i)) && (k = i)), C.send(l.uri + "#callback", k, n - l.startTime))
    }
    ...
    function n(b, c) {
        var d = null, e = a.platform, f = b.split("."), h = b.lastIndexOf("."), i = f[f.length - 2], j = f[f.length - 1], k = g(b.substring(0, h));
        (!k[j] || a.debuging) && ((d = c[a.platform]) || "browser" === e || ((d = a.iOS && c.iOS) ? e = "iOS" : (d = a.android && c.android) && (e = "android")), d && c.supportInvoke && (Q[i + "." + j] = d), k[j] = d ? d : m, c.support && c.support[e] && (P[i + "." + j] = c.support[e]))
    }

    function o(b) {
        var c, d, e = b.split("."), f = e[e.length - 2] + "." + e[e.length - 1];
        return c = P[f] || P[b.replace("qw.", "mqq.").replace("qa.", "mqq.")], a.isObject(c) && (c = c[a.iOS ? "iOS" : a.android ? "android" : "browser"]), c ? (d = c.split("-"), 1 === d.length ? a.compare(d[0]) > -1 : a.compare(d[0]) > -1 && a.compare(d[1]) < 1) : !1
    }

    function p(c, d, f, g) {
        function h() {
            l(g, {r: -201, result: "error"})
        }

        e({from: "openURL", ns: d || "", method: f || "", url: c});
    ...
    function q(b, c) {
        if ("AndroidQQ" === a.platform) {
            ...
            if (T[b] && a.compare(T[b]) < 0)return !0
        }
        return !1
    }
    ...
    function y(a, b) {
        ...
        var c = "evt-" + a;
        return (N[c] = N[c] || []).push(b), !0
    }

    function z(a, b) {
        var c, d = "evt-" + a, e = N[d], f = !1;
        if (!e)return !1;
        if (!b)return delete N[d], !0;
        for (c = e.length - 1; c >= 0; c--)b === e[c] && (e.splice(c, 1), f = !0);
        return f
    }

    function A(a) {
        var b = "evt-" + a, c = N[b], d = F.call(arguments, 1);
    ...
    function B(b, c, d) {
        var e, g = {event: b, data: c || {}, options: d || {}};
    ...
    var C, D = navigator.userAgent, E = window.MQQfirebug, F = Array.prototype.slice, G = Object.prototype.toString, H = /\b(iPad|iPhone|iPod)\b.*? OS ([\d_]+)/, I = /\bAndroid([^;]+)/, J = /\bQQ\/([\d\.]+)/, K = /\bIPadQQ\/([\d\.]+).*?\bQQ\/([\d\.]+)/, L = /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/, M = /\bTribe\/([\d\.]+)/, N = a.__aCallbacks || {}, O = a.__aReports || {}, P = a.__aSupports || {}, Q = a.__aFunctions || {}, R = 1, S = -1e5, T = {
        qbizApi: "5.0",
        pay: "999999",
    ...
    }, U = ["pbReport", "popBack", "close", "qqVersion"];
    return E ? (a.debuging = !0, D = E.ua || D) : a.debuging = !1, c(a, function () {
    ...
    }()), a.iOS = H.test(D), a.android = I.test(D), a.iOS && a.android && (a.iOS = !1), a.version = "20160901014", a.QQVersion = "0", a.clientVersion = "0", a.ERROR_NO_SUCH_METHOD = "no such method", a.ERROR_PERMISSION_DENIED = "permission denied", a.compare = function (b) {
        return d(a.clientVersion, b)
    }, a.platform = function () {
        var c, e, f = "browser";
        return a.android && ((c = D.match(L)) && c.length ? (a.QQVersion = a.clientVersion = (d(c[1], c[3]) >= 0 ? c[1] : c[3]) || "0", f = "AndroidQQ") : (c = D.match(M)) && c.length && (a.clientVersion = c[1] || "0", f = "AndroidTribe"), window.JsBridge = window.JsBridge || {}, window.JsBridge.callMethod = s, window.JsBridge.callback = l, window.JsBridge.compareVersion = a.compare), a.iOS && (a.__RETURN_VALUE = b, (c = D.match(K)) && c.length ? (a.clientVersion = c[1] || "0", a.QQVersion = c[2] || a.clientVersion, f = "iPadQQ") : (c = D.match(J)) && c.length ? (a.QQVersion = a.clientVersion = c[1] || "0", f = "iPhoneQQ") : (c = D.match(M)) && c.length ? (a.clientVersion = c[1] || "0", f = "iOSTribe") : (e = s("device", "qqVersion"), e && (a.QQVersion = a.clientVersion = e, f = "iPhoneQQ")), window.iOSQQApi = a), f
    }(), R = function () {
        var a, b = 1;
        for (a in N)N.hasOwnProperty(a) && (a = Number(a), isNaN(a) || (b = Math.max(b, a)));
        return ++b
    }(), C = function () {
        function b() {
            var c, g = d, k = {};
        ...
        function c(a, c, h) {
            var i;
            (c !== S || (c = 0, i = Math.round(Math.random() * j) % j, 1 === i)) && (d.push([a, c || 0, h || 0]), f || (g = Date.now(), f = setTimeout(b, e)))
        }

        var d = [], e = 500, f = 0, g = 0, h = 1000218, i = 1000280, j = 100, k = String(a.QQVersion).split(".").slice(0, 3).join("."), l = a.platform + "_MQQ_" + k, m = a.platform + a.QQVersion + "/" + a.version;
        return {send: c}
    }(), a.__aCallbacks = N, a.__aReports = O, a.__aSupports = P, a.__aFunctions = Q, a.__fireCallback = k, a.__reportAPI = f, c(a, {
        invoke: t,
        invokeClient: s,
        invokeSchema: u,
        invokeURL: r,
    ...
    function c(a, c) {
        ...
        for (var d in a) {
            ...
            if (e && e.length && Array.isArray(e)) {
                var f = window[d];
                if (f)"object" == typeof f && f.getClass && (l[d] = f, window[d] = {}); else {
                    if (!k)continue;
                    window[d] = {}
                }
                var g = l[d];
    ...
    var d = Array.prototype.slice, e = {QQApi: ["isAppInstalled", "isAppInstalledBatch", "startAppWithPkgName", "checkAppInstalled", "checkAppInstalledBatch", "getOpenidBatch", "startAppWithPkgNameAndOpenId"]}, f = {QQApi: ["lauchApp"]}, g = {publicAccount: ["close", "getJson", "getLocation", "hideLoading", "openInExternalBrowser", "showLoading", "viewAccount"]}, h = {
    ...
    }, i = {coupon: ["addCoupon", "addFavourBusiness", "gotoCoupon", "gotoCouponHome", "isCouponValid", "isFavourBusiness", "isFavourCoupon", "removeFavourBusiness"]}, j = navigator.userAgent, k = /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/.test(j) && (mqq.compare("4.5") > -1 || /_NZ\b/.test(j)), l = {};
    ...
    }, supportInvoke: !0, support: {android: "4.2"}
    ...
    android: function () {
        var a, b = {}, c = 0, d = function (a) {
            if (c > 0) {
                ...
                if ("object" == typeof a && g)for (; d = a[f]; f++)(e = b[d.appid]) && e(d); else(e = b[a.appid]) && e(a)
            }
        };
        return function (e, f) {
    ...
    }(), supportInvoke: !0, support: {android: "4.5"}
}), mqq.build("mqq.app.isAppInstalled", {
    iOS: function (a, b) {
        return mqq.invokeClient("app", "isInstalled", {scheme: a}, b)
    }, android: function (a, b) {
        mqq.invokeClient("QQApi", "isAppInstalled", a, b)
    }, supportInvoke: !0, support: {iOS: "4.2", android: "4.2"}
}), mqq.build("mqq.app.isAppInstalledBatch", {
    iOS: function (a, b) {
        return mqq.invokeClient("app", "batchIsInstalled", {schemes: a}, b)
    }, android: function (a, b) {
    ...
    }, supportInvoke: !0, support: {iOS: "4.6", android: "4.6"}
    ...
    iOS: function (a, b, c) {
        ...
        } else mqq.invokeClient("coupon", "addFavourBusiness", {bid: a, sourceId: b, callback: mqq.callback(c)})
    }, android: function (a, b) {
        var c = mqq.callback(b, !0);
    ...
    iOS: function (a) {
        mqq.invokeClient("coupon", "goToCouponHomePage", {params: a})
    }, android: function (a) {
    ...
    iOS: function (a, b, c) {
        ...
        } else mqq.invokeClient("coupon", "isFavourBusiness", {bid: a, sourceId: b, callback: mqq.callback(c)})
    }, android: function (a, b) {
    ...
    iOS: function (a, b, c, d) {
        ...
        } else mqq.invokeClient("coupon", "isFavourCoupon", {bid: a, cid: b, sourceId: c, callback: mqq.callback(d)})
    }, android: function (a, b) {
    ...
    iOS: function (a, b, c, d) {
        ...
        } else mqq.invokeClient("coupon", "removeCoupon", {bid: a, cid: b, sourceId: c, callback: mqq.callback(d)})
    }, supportInvoke: !0, support: {iOS: "4.6"}
}), mqq.build("mqq.coupon.removeFavourBusiness", {
    iOS: function (a, b, c) {
        if ("object" == typeof a) {
            var d = a;
            (d.callback = mqq.callback(b)) && mqq.invokeClient("coupon", "removeFavourBusiness", d)
        } else mqq.invokeClient("coupon", "removeFavourBusiness", {bid: a, sourceId: b, callback: mqq.callback(c)})
    }, android: function (a, b) {
        var c = mqq.callback(b, !0);
    ...
    iOS: function (a, b) {
        ...
        mqq.data.fetchJson({
            ...
            params: {appids: JSON.stringify(c)}
        }, b)
    }, android: function (a, b) {
        var c = a.appIDs;
        mqq.data.fetchJson({
    ...
    }, supportInvoke: !0, support: {iOS: "4.5", android: "4.6"}
}), mqq.build("mqq.data.deleteH5Data", {
    iOS: function (a, b) {
        var c = mqq.callback(b || function () {
            });
        mqq.invokeClient("data", "deleteWebviewBizData", {callback: c, params: a})
    }, android: function (a, b) {
    ...
    iOS: function (a, b) {
        ...
        mqq.invokeClient("data", "deleteWebviewBizData", {callback: c, delallhostdata: 1, params: a})
    }, android: function (a, b) {
    ...
    window.clientCallback = function (a, c) {
        ...
        iOS: function (a, b) {
            var c = a.url, d = a.params || {}, e = a.options || {}, f = a.context;
            d._t = +new Date;
            ...
            var e = c.options || {}, f = e.method || "GET", g = {param: c.params, method: f};
            g = JSON.stringify(g);
            var h = a();
    ...
    iOS: function (a) {
        var b = {}, c = mqq.invokeClient("data", "getClipboard", b);
        a && a(c)
    }, android: function (a) {
        var b = {};
        a && (b.callback = mqq.callback(a)), mqq.invokeClient("data", "getClipboard", b)
    }, supportInvoke: !0, support: {iOS: "4.7.2", android: "4.7.2"}
}), function () {
    var a = function (a) {
        return function (b) {
            a(b.friends || [])
    ...
    mqq.build("mqq.data.getFriendInfo", {
        ...
        android: b,
        supportInvoke: !0,
        support: {iOS: "5.1.0", android: "5.1.0"}
    })
}(), function () {
    var a = function (a) {
        return function (b) {
    ...
    mqq.build("mqq.data.getFriendRemark", {
        ...
        android: b,
        supportInvoke: !0,
        support: {iOS: "5.8.0", android: "5.8.0"}
    })
}(), mqq.build("mqq.data.getPageLoadStamp", {
    iOS: function (a) {
        mqq.invokeClient("data", "getPageLoadStamp", {callback: mqq.callback(a)})
    }, android: function (a) {
    ...
    var a = function (a) {
        return function (b) {
            if (mqq.android && b && void 0 === b.result) {
                ...
                b = {result: 0, data: b, message: "成功"}
            }
            a(b)
        }
    }, b = function (b) {
        if (mqq.compare("4.7.1") >= 0)mqq.invokeClient("qw_data", "getPerformance", a(b)); else try {
            common.getPerformance(a(b))
        } catch (c) {
            b({result: -1, message: "该接口在手Q v4.7.1 或以上才支持！", data: null})
        }
    };
    mqq.build("mqq.data.getPerformance", {
        ...
        android: b,
        supportInvoke: !0,
        support: {iOS: "4.7.1", android: "4.7.1"}
    })
}(), mqq.build("mqq.data.getUrlImage", {
    iOS: function (a, b) {
        var c = b ? mqq.callback(b) : null;
        mqq.invokeClient("data", "getUrlImage", {callback: c, params: a})
    }, android: function (a, b) {
    ...
    iOS: function (a) {
        ...
        mqq.invokeClient("data", "userInfo", {callback: mqq.callback(a)})
    }, supportInvoke: !0, support: {iOS: "4.7", android: "4.7"}
}), mqq.build("mqq.data.getWebRunEnv", {
    iOS: function (a) {
        mqq.invokeClient("data", "getWebviewRunningEnvironment", {callback: mqq.callback(a)})
    }, android: function (a) {
        mqq.invokeClient("data", "getWebviewRunningEnvironment", {callback: mqq.callback(a)})
    }, supportInvoke: !0, support: {iOS: "5.7", android: "6.0"}
    ...
    mqq.build("mqq.data.onFirstScreen", {android: i, support: {android: "5.4.0"}})
}(), mqq.build("mqq.data.pbReport", {
    iOS: function (a, b) {
        mqq.invokeClient("data", "pbReport", {type: String(a), data: b})
    }, android: function (a, b) {
    ...
    iOS: function (a, b) {
        var c = b ? mqq.callback(b) : null;
        mqq.invokeClient("data", "readWebviewBizData", {callback: c, params: a})
    }, android: function (a, b) {
    ...
    }, supportInvoke: !0, support: {iOS: "4.5", android: "4.7"}
    ...
    iOS: function (a) {
        ...
        mqq.invokeClient("data", "setReturnBackResult", a)
    }, supportInvoke: !0, support: {iOS: "5.8", android: "5.8"}
}), mqq.build("mqq.data.setShareInfo", {
    iOS: function (a, b) {
        return a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])), a.desc && (a.desc = a.desc.length > 50 ? a.desc.substring(0, 50) + "..." : a.desc), mqq.invokeClient("data", "setShareInfo", {params: a}, b)
    }, android: function (a, b) {
    ...
    iOS: function (a, b) {
        ...
        a.data = JSON.stringify(a.data || {}), a.callback = mqq.callback(b), mqq.invokeClient("sso", "sendRequest", a)
    }, supportInvoke: !0, support: {iOS: "5.3.2", android: "5.3.2"}
    ...
    iOS: function (a, b) {
        ...
        var c = a.data;
        c && ("object" == typeof c && (c = JSON.stringify(c)), a.data = encodeURIComponent(c)), mqq.invokeClient("publicAccount", "writeH5Data", a, mqq.callback(b || function () {
            }, !0))
    }, supportInvoke: !0, support: {iOS: "4.6", android: "4.6"}
}), function () {
    var a = function (a) {
    ...
    mqq.build("mqq.debug.detailLog", {iOS: b, android: b, supportInvoke: !0, support: {iOS: "5.8.0", android: "5.8.0"}})
}(), mqq.build("mqq.debug.hide", {
    iOS: function (a) {
        return mqq.compare("4.7.1") >= 0 ? (null == a && (a = !0), mqq.invokeClient("qw_debug", "hide", {flag: a})) : void 0
    }, android: function (a) {
        return mqq.compare("4.7.1") >= 0 ? (null == a && (a = !0), mqq.invokeClient("qw_debug", "hide", {flag: a})) : void 0
    }, supportInvoke: !0, support: {iOS: "4.7.1", android: "4.7.1"}
}), mqq.build("mqq.debug.log", {
    iOS: function (a) {
        var b = "", c = function (a) {
            return null === a ? "null" : void 0 === a ? "undefined" : Object.prototype.toString.call(a).slice(8, -1).toLowerCase()
        }, d = c(a);
        return b = "function" === d ? a.toString() : "string" === d ? a : "array" === d ? "[" + a.join() + "]" : JSON.stringify(a), mqq.compare("4.7.1") >= 0 ? mqq.invokeClient("qw_debug", "log", {msg: b}) : void 0
    }, android: function (a) {
        var b = "", c = function (a) {
            return null === a ? "null" : void 0 === a ? "undefined" : Object.prototype.toString.call(a).slice(8, -1).toLowerCase()
        }, d = c(a);
        b = "function" === d ? a.toString() : "string" === d ? a : "array" === d ? "[" + a.join() + "]" : JSON.stringify(a), mqq.compare("4.7.1") >= 0 && mqq.invokeClient("qw_debug", "log", {msg: b})
    }, supportInvoke: !0, support: {iOS: "4.7.1", android: "4.7.1"}
}), mqq.build("mqq.debug.show", {
    iOS: function (a) {
        return mqq.compare("4.7.1") >= 0 ? (null == a && (a = !0), mqq.invokeClient("qw_debug", "show", {flag: a})) : void 0
    }, android: function (a) {
        mqq.compare("4.7.1") >= 0 && (null == a && (a = !0), mqq.invokeClient("qw_debug", "show", {flag: a}))
    }, supportInvoke: !0, support: {iOS: "4.7.1", android: "4.7.1"}
    ...
    iOS: function (a) {
        var b = {qqVersion: this.qqVersion(), qqBuild: this.qqBuild()}, c = mqq.callback(a);
        ...
        if (mqq.compare("4.6") >= 0) {
            ...
            qqVersion: mqq.QQVersion, qqBuild: function (a) {
    ...
    }, supportInvoke: !0, support: {iOS: "4.5", android: "4.5"}
}), function () {
    function a(a, c) {
        "string" == typeof a && /^{.*?}$/.test(a) && (a = JSON.parse(a)), a && "radio" in a && (1 === a.type ? a.radio = "wifi" : a.type >= 2 ? a.radio = b[a.radio] || a.radio : a.radio = "unknown"), c && c(a)
    }
    ...
    mqq.build("mqq.device.getNetworkInfo", {
        ...
        }, supportInvoke: !0, support: {iOS: "5.2", android: "5.2"}
    })
    ...
    iOS: function (a) {
        ...
        mqq.compare("4.6") >= 0 ? mqq.invokeClient("qbizApi", "getNetworkType", a) : mqq.invokeClient("publicAccount", "getNetworkState", function (b) {
            var c = {"-1": 0, 0: 3, 1: 1}, d = b in c ? c[b] : 4;
            a(d)
        })
    }, supportInvoke: !0, support: {iOS: "4.5", android: "4.6"}
    ...
    iOS: function (a, b) {
        !a.outMaxWidth && a.maxWidth && (a.outMaxWidth = a.maxWidth, delete a.maxWidth), !a.outMaxHeight && a.maxHeight && (a.outMaxHeight = a.maxHeight, delete a.maxHeight), a.callback = mqq.callback(function (a, c) {
            c && c.forEach && c.forEach(function (a, b) {
                "string" == typeof a && (c[b] = {data: a, imageID: "", match: 0})
            }), b && b(a, c)
    ...
    iOS: function (a, b) {
        ...
        a.callback = mqq.callback(b, !1), mqq.invokeClient("media", "saveImage", a)
    }, supportInvoke: !0, support: {iOS: "5.1", android: "5.2"}
    ...
    android: function (a, b) {
        ...
        a = a || {}, b && (a.callback = mqq.callback(b)), mqq.addEventListener("tagDiscovered", b)
    }, supportInvoke: !0, support: {android: "6.5.5", iOS: "6.5.5"}
    ...
    }, supportInvoke: !0, support: {iOS: "5.4", android: "5.4"}
    ...
    iOS: function (a) {
        mqq.invokeClient("offline", "disableCache", {callback: mqq.callback(a)})
    }, android: function (a) {
        var b = a;
        a = function (a) {
            try {
    ...
    iOS: function (a) {
        mqq.invokeClient("pay", "enablePay", {params: a})
    }, supportInvoke: !0, support: {iOS: "4.6"}
}), mqq.build("mqq.pay.pay", {
    iOS: function (a, b) {
        var c = b ? mqq.callback(b) : null;
        mqq.invokeClient("pay", "pay", {params: a, callback: c})
    }, supportInvoke: !0, support: {iOS: "4.6"}
    ...
    function c(a, b) {
        ...
        try {
            Zepto.ajax({
                type: "get", url: j + d, dataType: "json", data: c, timeout: 1e4, success: function (a) {
                    var c = {ret: a.ecode, count: 0};
                    0 == a.ecode && (c.count = a.new_msg_cnt), l[b].call(null, c), delete l[b]
                }, error: function () {
                    l[b].call(null, {ret: -1, list: []}), delete l[b]
                }
            })
        } catch (e) {
            l[b].call(null, {ret: -2, list: []}), delete l[b]
        }
    }

    function d(a, b) {
        if (0 == a.code) {
            var c = {ret: a.code, count: 0}, d = a.data.buffer;
            if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d, "undefined" != typeof d.msg)for (var e in d.msg)1 == d.msg[e].stat && c.count++;
            l[b].call(null, c)
        } else l[b].call(null, {ret: a.code, list: []});
        delete l[b]
    }

    var e = !1, f = {}, g = a("sid"), h = mqq.iOS ? 110 : mqq.android ? 109 : 0, i = mqq.QQVersion ? mqq.QQVersion : "", j = "http://msg.vip.qq.com/cgi-bin/", k = function () {
    ...
    mqq.build("mqq.redpoint.getNewMsgCnt", {
        iOS: function (a, e) {
            ...
            if (l[f] = e, k)mqq.redpoint.getAppInfo(a, function (a) {
                ...
                if (!Zepto)return void("function" == typeof e ? e({ret: -1e4, count: 0}) : null);
                c(appid, f)
            }
    ...
    function d(a, b) {
        if (0 == a.code) {
            var c = {ret: a.code, list: []}, d = a.data.buffer, e = [];
            if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d, "undefined" != typeof d.msg) {
                ...
                if (a.data.buffer = JSON.stringify(d), e.length > 0) {
                    c.list = e, mqq.redpoint.setAppInfo({appInfo: a.data}, function (a) {
                        console.log(JSON.stringify(a))
                    });
                    var k = a.data.appID, m = {
                        sid: g,
                        appid: k,
                        platid: h,
                        qqver: i,
    ...
    var a = function (a, b) {
        ...
        mqq.redpoint.isEnterFromRedPoint({path: a.path}, function (c) {
    ...
    iOS: function (a) {
        var b = arguments[arguments.length - 1], c = "object" == typeof a ? a : {};
        return "function" == typeof b && (c.callback = mqq.callback(b)), mqq.invokeClient("data", "queryCurrentLocation", c)
    }, android: function (a) {
        var b = arguments[arguments.length - 1], c = "object" == typeof a ? a : {}, d = mqq.callback(function (a) {
            var c = -1, d = null, e = null;
    ...
    }, supportInvoke: !0, support: {iOS: "4.5", android: "4.6", browser: "0"}
}), mqq.build("mqq.sensor.getRealLocation", {
    iOS: function (a, b) {
        var c = b ? mqq.callback(b) : null;
        return mqq.invokeClient("data", "getOSLocation", {params: a, callback: c})
    }, android: function (a, b) {
        a = JSON.stringify(a || {}), mqq.invokeClient("publicAccount", "getRealLocation", a, mqq.callback(b, !0))
    }, supportInvoke: !0, support: {iOS: "4.6", android: "4.6"}
}), mqq.build("mqq.sensor.getSensorStatus", {
    iOS: function (a, b) {
        a = a || {type: "gps"}, a.callbackName = mqq.callback(b), mqq.invokeClient("sensor", "getSensorStatus", a)
    }, supportInvoke: !0, support: {iOS: "4.7"}
}), mqq.build("mqq.sensor.startAccelerometer", {
    iOS: function (a) {
        var b = mqq.callback(a, !1, !0);
        b && mqq.invokeClient("sensor", "startAccelerometer", {callback: b})
    }, android: function (a) {
        var b = mqq.callback(a, !1, !0);
    ...
    iOS: function (a) {
        var b = mqq.callback(a, !1, !0);
        b && mqq.invokeClient("sensor", "startCompass", {callback: b})
    }, android: function (a) {
        var b = mqq.callback(a, !1, !0);
    ...
    iOS: function (a) {
        var b = mqq.callback(a, !1, !0);
        b && mqq.invokeClient("sensor", "startListen", {callback: b})
    }, android: function (a) {
        var b = mqq.callback(a, !1, !0);
    ...
    android: function (a, b) {
        ...
        mqq.invokeClient("pay", "buyGoods", JSON.stringify(a), b)
    }, supportInvoke: !0, support: {android: "4.6.1", iOS: "6.5.0"}
    ...
    }, supportInvoke: !0, support: {android: "5.3.0"}
}),mqq.build("mqq.tenpay.openService", {
    iOS: function (a, b) {
        mqq.invokeClient("pay", "openService", JSON.stringify(a), b)
    }, android: function (a, b) {
        mqq.invokeClient("pay", "openService", JSON.stringify(a), b)
    }, supportInvoke: !0, support: {iOS: "5.7", android: "4.6.1"}
}),mqq.build("mqq.tenpay.openTenpayView", {
    iOS: function (a, b) {
        var c = b ? mqq.callback(b) : null;
        mqq.invokeClient("pay", "openTenpayView", {params: a, callback: c})
    }, android: function (a, b) {
        mqq.invokeClient("pay", "openTenpayView", JSON.stringify(a), b)
    }, supportInvoke: !0, support: {iOS: "4.6.1", android: "4.6.1"}
}),function () {
    var a = function (a) {
        return function (b, c, d) {
            ...
            b = Number(b);
            var f = {resultCode: b, retmsg: "", data: {}};
            if (0 === b) {
                var g = c;
    ...
    mqq.build("mqq.tenpay.pay", {
        iOS: function (b, c) {
            ...
            b.token_id = b.tokenId || b.tokenID || b.prepayId, b.app_info = b.app_info || b.appInfo, mqq.compare("4.6.1") >= 0 ? mqq.invokeClient("pay", "pay", JSON.stringify(b), c) : mqq.invokeSchema("mqqapi", "tenpay", "pay", b, a(c))
        }, supportInvoke: !0, support: {iOS: "4.6.1", android: "4.6.1"}
    })
}(),mqq.build("mqq.tenpay.rechargeGameCurrency", {
    android: function (a, b) {
        mqq.invokeClient("pay", "rechargeGameCurrency", JSON.stringify(a), b)
    }, supportInvoke: !0, support: {android: "4.6.1"}
    ...
    }, supportInvoke: !0, support: {iOS: "5.4", android: "4.6.1"}
}),mqq.build("mqq.ui.addShortcut", {
    iOS: function (a) {
        mqq.invokeClient("nav", "openLinkInSafari", {url: "http://open.mobile.qq.com/sdk/shortcut.ios.html?" + mqq.toQuery(a) + "#from=mqq"})
    }, android: function (a) {
        a.data = {
            title: a.title,
            icon: a.icon,
    ...
    iOS: function (a) {
        ...
        mqq.invokeClient("ui", "openSpecialView", {viewName: "troopMemberCard", param: a})
    }, supportInvoke: !0, support: {iOS: "5.8", android: "5.8"}
}),mqq.build("mqq.ui.openGroupFileView", {
    iOS: function (a) {
        mqq.invokeClient("ui", "openGroupFileView", a)
    }, android: function (a) {
        mqq.invokeClient("ui", "openSpecialView", {viewName: "groupFile", param: a})
    }, supportInvoke: !0, support: {iOS: "5.4", android: "5.4"}
}),mqq.build("mqq.ui.openGroupPhotoView", {
    iOS: function (a) {
        mqq.invokeClient("ui", "openGroupPhotoView", a)
    }, android: function (a) {
        mqq.invokeClient("ui", "openSpecialView", {viewName: "groupPhoto", param: a})
    }, supportInvoke: !0, support: {iOS: "5.4", android: "5.4"}
}),function () {
    function a(a) {
        var b = c[a], e = +new Date;
    ...
    mqq.build("mqq.ui.openUrl", {
        iOS: function (c) {
            if (a(c.url)) {
                c || (c = {});
                var d = b(c.url);
                2 === c.target ? mqq.invokeClient("nav", "openLinkInSafari", {url: d}) : 1 === c.target ? (c.styleCode = {
                        1: 4,
                        2: 2,
                        3: 5
    ...
    iOS: function (a) {
        ...
        var b = mqq.callback(a.callback);
        a.callback = b, mqq.invokeClient("ui", "selectContact", a)
    }, supportInvoke: !0, support: {iOS: "5.3", android: "5.3"}
}),mqq.build("mqq.ui.setActionButton", {
    iOS: function (a, b) {
        "object" != typeof a && (a = {title: a});
        var c = mqq.callback(b);
    ...
    iOS: function (a) {
        mqq.invokeClient("ui", "setOnCloseHandler", {callback: mqq.callback(a)})
    }, android: function (a) {
        mqq.invokeClient("ui", "setOnCloseHandler", {callback: mqq.callback(a)})
    }, supportInvoke: !0, support: {iOS: "4.7", android: "4.7"}
}),mqq.build("mqq.ui.setOnShareHandler", {
    iOS: function (a) {
        mqq.invokeClient("nav", "addWebShareListener", {callback: mqq.callback(a)})
    }, android: function (a) {
        mqq.invokeClient("ui", "setOnShareHandler", {callback: mqq.callback(a)})
    }, supportInvoke: !0, support: {iOS: "4.7.2", android: "4.7.2"}
    ...
    }, supportInvoke: !0, support: {iOS: "5.3"}
}),mqq.build("mqq.ui.setTitleButtons", {
    iOS: function (a) {
        var b = a.left, c = a.right;
        b && (b.callback = mqq.callback(b.callback)), c && (c.callback = mqq.callback(c.callback)), mqq.compare("5.3") >= 0 ? mqq.invokeClient("ui", "setTitleButtons", a) : (b && (b.title && mqq.invokeClient("ui", "setLeftBtnTitle", {title: b.title}), b.callback && mqq.invokeClient("ui", "setOnCloseHandler", b)), c && mqq.invokeClient("nav", "setActionButton", c))
    }, android: function (a) {
        var b = a.left, c = a.right;
    ...
    }, supportInvoke: !0, support: {iOS: "5.0", android: "4.6"}
}),mqq.build("mqq.ui.setWebViewBehavior", {
    iOS: function (a) {
        mqq.invokeClient("ui", "setWebViewBehavior", a)
    }, android: function (a) {
        mqq.invokeClient("ui", "setWebViewBehavior", a)
    }, supportInvoke: !0, support: {iOS: "4.7.2", android: "5.1"}
    ...
    iOS: function (a, b) {
        ...
        if (a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])), a.callback = mqq.callback(function (a) {
            ...
            mqq.app.isAppInstalled("com.tencent.mm", function (b) {
                b ? mqq.invokeClient("QQApi", "shareMsg", a) : mqq.support("mqq.ui.showTips") ? mqq.ui.showTips({text: c}) : alert(c)
            })
    ...
    iOS: function (a, b) {
        ...
        a.puin = a.oaUin, a.desc = a.desc || a.summary, a.desc && (a.desc = a.desc.length > 50 ? a.desc.substring(0, 50) + "..." : a.desc), mqq.compare("5.0") >= 0 ? (a.share_url = a.share_url || a.targetUrl, a.image_url = a.image_url || a.imageUrl, a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])), a.callback = b ? mqq.callback(function (a) {
            b({ret: a ? 0 : 1})
    ...
    iOS: function (a, b) {
        ...
        if (mqq.compare("4.8.0") >= 0)a.callback = mqq.callback(b, !0), mqq.invokeClient("ui", "showDialog", a); else {
            var c = "", d = "";
    ...
    iOS: function (a, b) {
        ...
        var c = mqq.callback(b);
        c && (a.callback = c), mqq.invokeClient("viewTracks", "getTrackInfo", a)
    }, supportInvoke: !0, support: {iOS: "5.1", android: "5.1"}
